...
#include "data/SimpleFlanger.h"

#define SF_ID(x) "IDSF_"##x
#define PARAM_BEGIN_DELAY "beginDelayTime"
#define PARAM_END_DELAY  "endDelayTime"
...
public:
	...
	juce::AudioProcessorValueTreeState::ParameterLayout getParamLayout();

	juce::AudioProcessorValueTreeState m_apvts;
	SimpleFlanger simpleFlangerTest;
	bool isFollowBPM;
