...
void PhaseViewer::paint (juce::Graphics& g)
{
    ...
    */
    ...
    g.drawSingleLineText("0", bound.getX(), bound.getBottom() + kTextSize);
    g.drawSingleLineText(juce::String(m_maxPhase), bound.getRight() - 2 * kTextSize, bound.getBottom() + kTextSize);
